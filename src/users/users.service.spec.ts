...
describe('UserService', () => {
  ...
  describe('createAccount', () => {
    ...
    it('should fail if user exists', async () => {
      ...
      expect(result).toMatchObject({ ok: false, error: 'exist email' });
    });
  ...
  describe('login', () => {
    ...
    it('should fail if user does not exist', async () => {
      ...
      expect(result).toEqual({ ok: false, error: 'not exist email' });
    });
    ...
    it('should fail if the password is wrong', async () => {
      ...
      const result = await service.login(loginArgs);
      expect(result).toEqual({ ok: false, error: 'not matching password' });
    });
  ...
  describe('verifyEmail', () => {
    ...
    it('should fail on verification not found', async () => {
      ...
      const result = await service.verifyEmail(verifyEmailArgs.code);
      expect(result).toEqual({ ok: false, error: 'verificaion not found' });
    });
